...
class Cplus_variable extends StatelessWidget {
  const Cplus_variable({super.key});
            ...
            Container(
              ...
              child: Container(
                child: SfPdfViewer.network('https://firebasestorage.googleapis.com/v0/b/code-wizard-932a2.'
                    'appspot.com/o/files%2Fc%2B%2B%2Fc%2B%2B%20comment.pdf?alt=media&token=d2d41484-6527-42a3-984d'
                    '-64ee54c35921&_gl=1*1rjs946*'
